...
class BasicExportConfig(models.Model):
    ...
    ccn_sueldo = models.CharField(max_length=20, verbose_name='Nombre de Concepto Sueldo')
    ccn_no_rem = models.CharField(max_length=20, null=True, blank=True, verbose_name='Nombre de Concepto NR')
    ccn_no_osysind = models.CharField(max_length=20, null=True, blank=True, verbose_name='Nombre de Concepto NR OS y Sind')
    ccn_no_sind = models.CharField(max_length=20, null=True, blank=True, verbose_name='Nombre de Concepto NR Sind.')
    ccn_sijp = models.CharField(max_length=20, verbose_name='Nombre de Concepto SIJP')
    ccn_inssjp = models.CharField(max_length=20, verbose_name='Nombre de Concepto INSSJP')
    ccn_os = models.CharField(max_length=20, verbose_name='Nombre de Concepto OS')
    ccn_sindicato = models.CharField(max_length=20, null=True, blank=True, verbose_name='Nombre de Concepto Sindicato')
